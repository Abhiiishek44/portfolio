...
const AboutSection = () => {
  return (
    <div className="flex flex-col gap-5">
      <h1 className="text-4xl font-bold font-geist text-[#f4f2f3] flex items-center gap-3">
        About Me!
      </h1>

      <div className="font-geist text-[#d4ced2] text-[18px] leading-[29px] space-y-6 font-normal">
        <p>
